class php {
    ...
    $packages = ['php5', 'php5-dev', 'php5-mcrypt', 'php-xml-parser', 'php5-mysql', 'php5-cli', 'php5-curl', 'php5-fpm', 'libssh2-1-dev', 'php5-common', 'php-pear', 'php5-gd', 'php5-imagick', 'php5-xdebug', 'libpcre3-dev']
